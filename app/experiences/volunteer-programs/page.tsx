...
const BookIcon = ({ className = "" }) => (
    <svg className={`w-6 h-6 mr-2 ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
);

const WomanIcon = ({ className = "" }) => (
    <svg className={`w-6 h-6 mr-2 ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
);

const LeafIcon = ({ className = "" }) => (
    <svg className={`w-6 h-6 mr-2 ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
);

const PawIcon = ({ className = "" }) => (
    <svg className={`w-6 h-6 mr-2 ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 9l6-6M9 14l-6 6M17 17l4 4m-4-4l4-4m-4 4V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2h7m-8-2v-4a1 1 0 011-1h4a1 1 0 011 1v4m-5 0h6m-3-11v2m-3-3v3m0 0h2"></path></svg>
);

const HandshakeIcon = ({ className = "" }) => (
    <svg className={`w-6 h-6 mr-2 ${className}`} fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1m0-1v-1m-1 0h2m-2-4v1m0-1v-1m-1 0h2m-2-4v1m0-1v-1m-1 0h2"></path></svg>
);
...
const ClockIcon = ({ className = "w-4 h-4" }) => (
    <svg className={className} fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
);

const StarIcon = ({ className = "w-4 h-4" }) => (
    <svg className={className} fill="currentColor"><path d="M9.049 2.927c.3-.921 1.62-.921 1.92 0l1.242 3.826 4.026.292c.969.07 1.35 1.258.647 1.904l-3.072 2.235 1.157 3.901c.277.935-.769 1.642-1.574 1.144L10 15.17l-3.418 2.518c-.805.593-1.851-.109-1.574-1.044l1.157-3.901L3.14 9.049c-.703-.646-.322-1.834.647-1.904l4.026-.292L9.049 2.927z"></path></svg>
);
...
const ProgramCard = ({ program }) => (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transform hover:shadow-2xl hover:-translate-y-1 transition duration-300">
        ...
        <div className="p-5">
            ...
            <a href={`/apply/${program.id}`} className="w-full block text-center px-4 py-2.5 rounded-lg bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition">
                Apply Now
            </a>
        </div>
    </div>
                        ...
                        {categories.map((category) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center px-4 py-2 rounded-full text-sm font-semibold transition duration-200 ${active
