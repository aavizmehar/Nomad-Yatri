...
const BookIcon = () => (
  <svg className="w-6 h-6 mr-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
);
// Icon for Category: Women Empowerment
const WomanIcon = () => (
  <svg className="w-6 h-6 mr-2 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
);
...
const PawIcon = () => (
  <svg className="w-6 h-6 mr-2 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 9l6-6M9 14l-6 6M17 17l4 4m-4-4l4-4m-4 4V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2h7m-8-2v-4a1 1 0 011-1h4a1 1 0 011 1v4m-5 0h6m-3-11v2m-3-3v3m0 0h2"></path></svg>
);
// Icon for Community Development
const HandshakeIcon = () => (
  <svg className="w-6 h-6 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1m0-1v-1m-1 0h2m-2-4v1m0-1v-1m-1 0h2m-2-4v1m0-1v-1m-1 0h2"></path></svg>
);
// Icon for Location
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {['All', ...categories].map(category => {
              ...
              return (
                ...
                >
                  {Icon && <Icon className="w-4 h-4 mr-1 transition-colors" />}
                  {category}
                </button>
              );
            })}
